...
ipreacher_width = 585
secondary_text_x = 618
basic_text_y = 119


def generate_idea():
    y_text_split = ipreacher_width + 1
    height = 150
    rect_length = 10
    width = 888
    max_rect_length = 40

    dwg = svgwrite.Drawing('/Users/wonderful/Desktop/idea.svg', profile='full', size=(u'888', u'150'))
    ...
    g.add(dwg.rect((0, 0), (ipreacher_width, height), fill='#5E6772'))
    g.add(dwg.rect((ipreacher_width, 0), (width - ipreacher_width, height), fill='#2196F3'))

    shapes = dwg.add(dwg.g(id='shapes', fill='none'))

    slogan_link = Hyperlink('https://ipreacher.github.io/', target='_blank')
    shapes.add(dwg.text('ipreacher', insert=(44, basic_text_y + 1), fill='#000', fill_opacity=0.3, font_size=120,
                        font_family='Helvetica'))

    slogan_link.add(
        dwg.text('ipreacher', insert=(43, basic_text_y), fill='#FFFFFF', font_size=120, font_family='Helvetica'))
    dwg.add(slogan_link)
...
def generate_article():
    dwg = svgwrite.Drawing('/Users/wonderful/Desktop/article.svg', size=(u'970', u'150'))
    ...
    g = dwg.add(dwg.g(id='g', fill='none', mask='url(#a)'))
    g.add(dwg.rect((0, 0), (ipreacher_width, height), fill='#5E6772'))
    g.add(dwg.rect((ipreacher_width, 0), (width - ipreacher_width, height), fill='#ffeb3b'))
    ...
    g.add(dwg.text(insert=(ipreacher_width, 16), fill='#34495e', opacity=0.2, font_size=12,
    ...
    g.add(dwg.text(insert=(ipreacher_width, 112), fill='#34495e', opacity=0.2, font_size=12,
                   text=' tincidunt quis, accumsan porttitor, facilisis luctus, metus'))
    g.add(dwg.text(insert=(ipreacher_width, 128), fill='#34495e', opacity=0.2, font_size=12,
    ...
    g.add(dwg.text(insert=(ipreacher_width, 144), fill='#34495e', opacity=0.2, font_size=12,
    ...
    g.add(dwg.text(insert=(ipreacher_width, 160), fill='#34495e', opacity=0.2, font_size=12,
...
def generate_works():
    dwg = svgwrite.Drawing('/Users/wonderful/Desktop/works.svg', size=(u'978  ', u'150'))
    ...
    g = dwg.add(dwg.g(id='g', fill='none', mask='url(#a)'))
    g.add(dwg.rect((ipreacher_width, 0), (width - ipreacher_width, height), fill='#2c3e50'))

    shapes = dwg.add(dwg.g(id='shapes', fill='none'))

    g.add(dwg.rect((ipreacher_width, 0), (426, 150), fill='#2c3e50'))

    for x in range(0, 300, 10):
        text = get_some_random10(100)
        g.add(
            dwg.text(text, insert=(ipreacher_width + 1, x), fill='#27ae60', font_size=12,
...
def generate_design():
    dwg = svgwrite.Drawing('/Users/wonderful/Desktop/design.svg', size=(u'1014', u'150'))
    ...
    shapes.add(dwg.rect((ipreacher_width, 25.6), (design_width, 30), fill='#2196f3'))

    shapes.add(dwg.rect((ipreacher_width, 90), (design_width, 60), fill='#2196f3'))

    shapes.add(dwg.text('design', insert=(secondary_text_x + 6, 120), fill='#000', stroke_width=4, font_size=120,
                        font_family='Helvetica'))
    shapes.add(dwg.rect((ipreacher_width, 0), (design_width, 90), fill='#03a9f4'))
    # shapes.add(dwg.rect((ipreacher_width, 88), (486, 3), fill='#e91e63'))
    shapes.add(dwg.rect((ipreacher_width, 90), (design_width, 0.2), fill='#000'))
